...
It's likely that ConvNeXt will sit inbetween ResNet and ViT but leaning toward ResNet and MLP-Mixer will sit outside of ViT as MLP-Mixer doesn't have Data Specificity like ViT. **TLDR: MLP-Mixer is a shite architecture so if I can improve it work on small tabular dataset, then I can also make Vision Transformer and Language Model works.**
